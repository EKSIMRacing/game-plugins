...
Almost All Plugins are usually included in the installer of Ledsmaster and MotionMax Manager. Check for update to get the latest version of plugins and keep your install up to date.
...
Codemasters / EA F1 23 XBox/PlayStation Console Bridge,
...
Others
Forza Motorsport 2023 (beta),
WRC Generations,
Forza Horizon 4 (beta),
Forza Horizon 5 (beta),
